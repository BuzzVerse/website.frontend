...
export declare type SwipeHandler = (direction: Direction) => void;
export declare type CardLeftScreenHandler = (direction: Direction) => void;
export declare type SwipeRequirementFufillUpdate = (
  direction: Direction
) => void;
export declare type SwipeRequirementUnfufillUpdate = () => void;
...
export declare const TinderCard: React.FC<Props>;
